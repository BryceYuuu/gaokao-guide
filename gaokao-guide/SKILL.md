...
| 最终志愿表、冲稳保排序 | `references/evidence-ledger.md`, `references/strategy-and-portfolio.md`, `references/output-templates.md` | 用户给 CSV/表格时读 `references/tooling.md` 并运行脚本；需要摘要时读 `references/dashboard-templates.md` |
| 学校怎么样、某校能不能报 | `references/school-major-audit.md`, `references/evidence-ledger.md`, `references/communication-style.md` | 多校对比时读 `references/output-templates.md` |
...
| 低估机会、避热、人生杠杆 | `references/strategy-and-portfolio.md`, `references/major-career-map.md` | 需要正式报告时读 `references/output-templates.md` |
...
若有可信数据表，可运行 `scripts/audit_candidates.py` 做字段、梯度、重复、保底深度和待核验项的机械审计。
